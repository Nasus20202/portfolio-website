...
class Projects extends React.Component
{
    constructor(props){
        ...
        this.projects = [
            ...
            {name: {'pl': 'Family App', 'en': 'Family App'}, about: {'pl': 'Aplikacja Internetowa ASP.NET Core przeznaczona dla rodzin. Zawiera wspolną listę zadań do zrobienia oraz liste zakupów. Posiada zintegrowany chat.', 'en': 'ASP.NET Core web app for families. Includes a shared to-do list and a shopping list. It has an integrated chat.'}, github: 'https://github.com/Nasus20202/FamilyApp', website: 'https://family.nasuta.dev/'},
            {name: {'pl': 'CubeList', 'en': 'CubeList'}, about: {'pl': 'Prosta aplikacja internetowa agregująca serwery do gry Minecraft.', 'en': 'Simple web application that aggregates Minecraft servers.'}, github: 'https://github.com/Nasus20202/MCserverList', website: 'https://cubelist.nasuta.dev/'},
            {name: {'pl': 'Django Store', 'en': 'Django Store'}, about: {'pl': 'Prosty sklep internetowy wykonany z użyciem frameworka Django. Umożliwia przeglądanie oraz zamawianie produktów. Przygotowany jako projekt do liceum.', 'en': 'A simple online store made using the Django framework. It allows you to view and order products. Prepared as a high school project.'}, github: 'https://github.com/Nasus20202/django-store', website: ''},
            ...
            {name: {'pl': 'Skracacz linków', 'en': 'Link cutter'}, about: {'pl': 'Aplikacja internetowa umożliwiająca zastąpienie długiego linku krótkim.', 'en': 'A web application that allows you to replace a long link with a short one.'}, github: 'https://github.com/Nasus20202/LinkCutter', website: 'https://link.nasuta.dev/'},
